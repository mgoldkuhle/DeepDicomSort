...
ROOT_FOLDER = cfg['preprocessing']['root_folder']
...
# optional paths in case you want to skip certain preprocessing steps
images_4D_file = '/mnt/share/DeepDicomSorted/DATA/Scans_4d.txt'
#nifti_resampled_folder = '/mnt/share/DeepDicomSorted/NIFTI_RESAMPLED'
nifti_slices_folder = '/mnt/share/DeepDicomSorted/NIFTI_SLICES'
...
#images_4D_file = NPF.extract_4D_images(ROOT_FOLDER)

#print('Reorient to standard space....')
#NPF.reorient_to_std(nifti_folder, FSLREORIENT_BIN)

#print('Resampling images....')
#nifti_resampled_folder = NPF.resample_images(ROOT_FOLDER, DEFAULT_SIZE)
