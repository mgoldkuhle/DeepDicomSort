            ...
            for i_file_name in files:
                try:
                    ...
                    if move_files:
                        ...
                        if os.path.isdir(dicom_output_folder):
                            dicom_output_folder = os.path.join(dicom_output_folder, i_file_name)
                        shutil.copyfile(full_file_path, dicom_output_folder)
